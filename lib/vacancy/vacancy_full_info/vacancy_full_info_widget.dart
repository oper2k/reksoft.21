...
class VacancyFullInfoWidget extends StatefulWidget {
  const VacancyFullInfoWidget({
    super.key,
  ...
  @override
  State<VacancyFullInfoWidget> createState() => _VacancyFullInfoWidgetState();
}

class _VacancyFullInfoWidgetState extends State<VacancyFullInfoWidget> {
  late VacancyFullInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VacancyFullInfoModel());
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          valueOrDefault<
                                                              String>(
                                                            'Специализация: ${widget.vacancy?.specialization}',
                                                            'Не указано',
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          valueOrDefault<
                                                              String>(
                                                            'Занятость: ${widget.vacancy?.employmentType} (${widget.vacancy?.workFormat})',
                                                            'Не указано',
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                        ...
                                                        Align(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  '${rowUsersRecord.displayName} ${rowUsersRecord.surname}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
