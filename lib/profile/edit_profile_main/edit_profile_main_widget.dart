...
import 'edit_profile_main_model.dart';
export 'edit_profile_main_model.dart';

class EditProfileMainWidget extends StatefulWidget {
  const EditProfileMainWidget({super.key});

  @override
  State<EditProfileMainWidget> createState() => _EditProfileMainWidgetState();
}

class _EditProfileMainWidgetState extends State<EditProfileMainWidget> {
  late EditProfileMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfileMainModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.socialLinks = (currentUserDocument?.socialLinks?.toList() ?? [])
          .toList()
          .cast<String>();
      _model.selectedCity = valueOrDefault(currentUserDocument?.city, '');
      setState(() {});
    });
    ...
    _model.surnameFieldTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.surname, ''));
    _model.surnameFieldFocusNode ??= FocusNode();

    _model.birthDateFieldTextController ??= TextEditingController();
    _model.birthDateFieldFocusNode ??= FocusNode();

    _model.languagesTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.languages, ''));
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.birthDateFieldTextController?.text = dateTimeFormat(
            'dd.MM.y',
            currentUserDocument?.birthdayDate,
                                                ...
                                                Padding(
                                                  ...
                                                  child: AuthUserStreamWidget(
                                                    builder: (context) =>
                                                        TextFormField(
                                                      controller: _model
                                                          .surnameFieldTextController,
                                                      focusNode: _model
                                                          .surnameFieldFocusNode,
                                                      autofocus: false,
                                                      textInputAction:
                                                          TextInputAction.next,
                                                      obscureText: false,
                                                      ...
                                                      cursorColor:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .primaryText,
                                                      validator: _model
                                                          .surnameFieldTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                                      ...
                                                      children: [
                                                        AuthUserStreamWidget(
                                                          builder: (context) =>
                                                              TextFormField(
                                                            controller: _model
                                                                .birthDateFieldTextController,
                                                            focusNode: _model
                                                                .birthDateFieldFocusNode,
                                                            autofocus: false,
                                                            textInputAction:
                                                                TextInputAction
                                                                    .next,
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            setState(() {
                                                              _model.birthDateFieldTextController
                                                                      ?.text =
                                                                  dateTimeFormat(
                                                                'dd.MM.y',
                                                                _model
                                                    ...
                                                    builder: (context) =>
                                                      ...
                                                      cursorColor:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .primaryText,
                                                      validator: _model
                                                          .languagesTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                                ...
                                                if (valueOrDefault(
                                                  ...
                                                  AuthUserStreamWidget(
                                                    builder: (context) =>
                                                        wrapWithModel(
                                                      model: _model
                                                          .socialLinksMainModel,
                                                      updateCallback: () =>
                                                          setState(() {}),
                                                      child:
                                                          SocialLinksMainWidget(
                                                        initialData:
                                                            (currentUserDocument
                                                                    ?.socialLinks
                                                                    ?.toList() ??
