...
import 'schema/response_record.dart';
...
export 'schema/response_record.dart';
...
/// Functions to query ResponseRecords (as a Stream and as a Future).
Future<int> queryResponseRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ResponseRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ResponseRecord>> queryResponseRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ResponseRecord.collection,
      ResponseRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ResponseRecord>> queryResponseRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
