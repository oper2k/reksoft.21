...
class ChatMessagesRecord extends FirestoreRecord {
  ...
  // "recepient" field.
  DocumentReference? _recepient;
  DocumentReference? get recepient => _recepient;
  bool hasRecepient() => _recepient != null;
  ...
  void _initializeFields() {
    ...
    _recepient = snapshotData['recepient'] as DocumentReference?;
