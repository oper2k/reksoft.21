...
import 'header_mobile_close_model.dart';
export 'header_mobile_close_model.dart';

class HeaderMobileCloseWidget extends StatefulWidget {
  const HeaderMobileCloseWidget({
    super.key,
  ...
  @override
  State<HeaderMobileCloseWidget> createState() =>
      _HeaderMobileCloseWidgetState();
}

class _HeaderMobileCloseWidgetState extends State<HeaderMobileCloseWidget> {
  late HeaderMobileCloseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeaderMobileCloseModel());
