        ...
        messages: [
          {
            role: "system",
            content:
              "Ты рекрутер. Твоя задача проанализировать чат между рекрутером и соискателем, проанализировать его и выдать саммари чата",
          },
          {
            role: "user",
            content: `Проанализируй следующий чат между рекрутером и соискателем и выдай саммари чата по всем заданным вопросам. Выбери основные посылы соискателя в каждом вопросе, проанализируй их, и выдай свой анализ и основные посылы. Игнорируй первое сообшение в json с ролью system
